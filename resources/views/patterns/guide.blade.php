                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div id="sewing" class="tab-content hidden">
                        ...
                        <table class="min-w-full table-auto border-collapse border border-gray-300 dark:border-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800">
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Backstitch</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">backstitch</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">backstitch</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">回针 (Huí zhēn)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Baste</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">baste</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">baste</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">大缝 (Dà fèng)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Buttonhole</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">buttonhole</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">buttonhole</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">钮孔 (Niǔ kǒng)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Cross-Stitch</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">cross-stitch</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">cross-stitch</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">十字绣 (Shízì xiù)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Gather</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">gather</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">gather</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">收集 (Shōují)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Hem</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">hem</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">hem</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">裤脚 (Kù jiǎo)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Overlock</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">serge / overlock</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">overlock</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">包边 (Bāo biān)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Patching</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">patch</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">patch</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">补丁 (Bǔ dīng)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Placket</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">placket</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">placket</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">门襟 (Mén jīn)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Pressing</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">press</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">press</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">熨烫 (Yùn tàng)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Seam</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">seam</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">seam</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">接缝 (Jiē fèng)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Tacking</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">tack</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">tack</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">定缝 (Dìng fèng)</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">Zipper</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">zipper</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">zip</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">拉链 (Lā liàn)</td>
                                </tr>
                            </tbody>
                        </table>
