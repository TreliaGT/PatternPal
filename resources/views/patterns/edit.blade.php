                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('patterns.update', $pattern->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="title" name="title" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800" required value="{{ old('title', $pattern->title) }}">
                            @error('title')
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="materials" name="materials" rows="5" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800" required>{{ old('materials', $pattern->materials) }}</textarea>
                            @error('materials')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="url" id="youtube_link" name="youtube_link" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-100 @error('youtube_link') border-red-500 @enderror" value="{{ old('youtube_link', $pattern->youtube_link) }}">
                            @error('youtube_link')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6" id="steps-container">
                            ...
                            @foreach($pattern->steps as $index => $step)
                                <div class="step-entry mb-4">
                                    <div class="mb-4">
                                        <label for="steps[{{ $index }}][title]" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Step Title</label>
                                        <input type="text" name="steps[{{ $index }}][title]" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-100" value="{{ old('steps.' . $index . '.title', $step->title) }}">
                                    </div>

                                    <div class="mb-4">
                                        <label for="steps[{{ $index }}][step]" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Step Description</label>
                                        <textarea name="steps[{{ $index }}][step]" rows="4" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-100">{{ old('steps.' . $index . '.step', $step->steps) }}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
    ...
    <script>
        document.getElementById('add-step').addEventListener('click', function() {
            ...
            newStepEntry.innerHTML = `
                <div class="mb-4">
                    <label for="steps[${stepCount}][title]" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Step Title</label>
                ...
                <div class="mb-4">
                    <label for="steps[${stepCount}][step]" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Step Description</label>
                    <textarea name="steps[${stepCount}][step]" rows="4" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-100"></textarea>
                </div>
            `;
